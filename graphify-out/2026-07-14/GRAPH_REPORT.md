...
## Corpus Check
- 20 files · ~557,679 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 97 nodes · 119 edges · 22 communities (7 shown, 15 thin omitted)
...
### Community 0 - "App.jsx"
Cohesion: 0.13
Nodes (13): App(), routes, contacts, ContactSection(), companyLinks, Footer(), links, productLinks (+5 more)
...
Cohesion: 0.50
Nodes (3): AboutPage(), Nametag3D, TeamLanyards
