...
export const teamMembersDetailed = [
  ...
  },
  {
    ...
    roles: ['Head of Operation', 'Supply Chain'],
    bio: 'Memastikan rantai pasok pakan organik, distribusi hasil panen, dan logistik mitra berjalan efisien dari hulu ke hilir.',
    image: andiCard, originX: 0.3,
    socials: { linkedin: '#', github: '#', instagram: '#' },
  },
  {
    id: 'dummy-2',
    name: 'Bambang Sutrisno',
    role: 'Aquaculture Lead',
    roles: ['Aquaculture Lead', 'Water Quality'],
    bio: 'Pakar budidaya perikanan air tawar. Mengawasi sistem akuaponik terpadu dan optimalisasi kualitas air untuk pertumbuhan ikan maksimal.',
    image: shafnatCard, originX: 0.9,
    socials: { linkedin: '#', github: '#', instagram: '#' },
  },
  {
    id: 'dummy-3',
    name: 'Dewi Sartika',
    role: 'IoT Engineer',
    roles: ['IoT Engineer', 'Embedded Systems'],
    bio: 'Mengembangkan firmware sensor PH/DO/suhu dan sistem telemetri real-time untuk pemantauan kolam jarak jauh berbasis LoRa.',
    image: andiCard, originX: -0.9,
    socials: { linkedin: '#', github: '#', instagram: '#' },
  },
  {
    id: 'dummy-4',
    ...
    roles: ['Agri-Tech Specialist', 'R&D'],
    bio: 'Meriset metode biokonversi limbah organik menggunakan BSF dan mengembangkan formula pakan alternatif berprotein tinggi.',
    image: shafnatCard, originX: -0.3,
    socials: { linkedin: '#', github: '#', instagram: '#' },
  },
  {
    id: 'dummy-5',
    ...
    roles: ['Marketing & Partnership', 'Community'],
    bio: 'Menjembatani Jago Farm dengan mitra peternak, komunitas petani urban, dan pasar produk organik di kota-kota besar.',
    image: andiCard, originX: 0.3,
    socials: { linkedin: '#', github: '#', instagram: '#' },
  },
  {
    ...
    name: 'Hendra Kusuma',
    role: 'Data Analyst',
    roles: ['Data Analyst', 'AI Modeling'],
    bio: 'Mengolah data sensor IoT dan hasil panen untuk membangun model prediktif produktivitas dan sistem rekomendasi pakan otomatis.',
    image: shafnatCard, originX: 0.9,
    socials: { linkedin: '#', github: '#', instagram: '#' },
  },
]
